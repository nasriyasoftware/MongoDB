...
declare class DataFilter {
     ...
     * @returns {DataFilter}
     */
    startsWith(property: string, value: string, options?: {
     ...
     * @returns {DataFilter}
     */
    endsWith(property: string, value: string, options?: {
        caseSensitive: boolean;
    }): DataFilter;
    /**
     ...
     * @returns {DataFilter}
     */
    contains(property: string, value: string, options?: {
        caseSensitive: boolean;
    }): DataFilter;
    /**
