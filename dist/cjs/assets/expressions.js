...
class Expressions {
    #_utils = {
        validateExpression: (expression) => {
            if (!(helpers_1.default.isValidString(expression) || helpers_1.default.isRealObject(expression))) {
    ...
    sum(expression) {
        ...
        return { $sum: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    average(expression) {
        this.#_utils.validateExpression(expression);
        return { $avg: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    min(expression) {
        this.#_utils.validateExpression(expression);
        return { $min: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    max(expression) {
        this.#_utils.validateExpression(expression);
        return { $max: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    first(expression) {
        this.#_utils.validateExpression(expression);
        return { $first: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    last(expression) {
        this.#_utils.validateExpression(expression);
        return { $last: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    addToSet(expression) {
        this.#_utils.validateExpression(expression);
        return { $addToSet: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    push(expression) {
        this.#_utils.validateExpression(expression);
        return { $push: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    multiply(expression) {
        this.#_utils.validateExpression(expression);
        return { $multiply: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    dateToString({ date, format }) {
        ...
        return { $dateToString: { format, date: helpers_1.default.isValidString(date) ? `$${date}` : date } };
    }
    /**
    ...
    dateFromString({ dateString, format }) {
        ...
        return { $dateFromString: { format, dateString: helpers_1.default.isValidString(dateString) ? `$${dateString}` : dateString } };
    }
    /**
    ...
    substr(expression, start, length) {
        this.#_utils.validateExpression(expression);
        const substr = { $substr: [helpers_1.default.isValidString(expression) ? `$${expression}` : expression, start] };
        if (length)
    ...
    trim(expression) {
        this.#_utils.validateExpression(expression);
        return { $trim: { input: helpers_1.default.isValidString(expression) ? `$${expression}` : expression } };
    }
    /**
    ...
    toUpperCase(expression) {
        this.#_utils.validateExpression(expression);
        return { $toUpper: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    toLowerCase(expression) {
        this.#_utils.validateExpression(expression);
        return { $toLower: helpers_1.default.isValidString(expression) ? `$${expression}` : expression };
    }
    /**
    ...
    geoNear(geoNearOptions) {
        if (!helpers_1.default.isRealObject(geoNearOptions)) {
...
exports.default = new Expressions();
