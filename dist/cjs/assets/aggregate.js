...
class DataAggregate {
     ...
     */
    group(grouping) {
        if (!helpers_1.default.isRealObject(grouping)) {
            throw new TypeError(`The group method expects a grouping object.`);
        }
     ...
     */
    facet(facets) {
        if (!helpers_1.default.isRealObject(facets)) {
            throw new TypeError(`The facet method expects an object but got ${typeof facets}`);
        }
    ...
    */
    customStage(stage) {
        if (!helpers_1.default.isRealObject(stage)) {
            throw new TypeError(`The customStage method expects an object but got ${typeof stage}.`);
        }
