import type { GeoNearOptions, GeoWithinOptions, GeoIntersectsOptions } from '../../../src/docs/docs';
...
declare class Expressions {
     ...
     */
    dateToString(options: { date: string | object; format: string }): object;
     ...
     */
    dateFromString(options: { dateString: string | object; format: string }): object;
