import type { NasriyaDataOptions, Grouping } from '../../../src/docs/docs';
...
declare class DataAggregate {
     ...
     */
    fields(options: { include?: string[] | undefined; exclude?: string[] | undefined; }): DataAggregate;
    ...
    */
     ...
     */
    execute(options?: NasriyaDataOptions | undefined): Promise<any[]>;
}
